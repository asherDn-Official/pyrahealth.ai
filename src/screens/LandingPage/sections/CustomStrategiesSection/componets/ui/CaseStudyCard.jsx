...
export const CaseStudyCard = ({ percentage, unit = "%", title, description, logo, logoWidth, logoHeight }) => {
  return (
    <Card className="w-full max-w-[378px] rounded-[40px] border shadow-[0px_4px_22.7px_#ffd3c4b2] hover:shadow-[0px_8px_30px_#ffd3c4b2] transition-shadow">
      <CardContent className="p-0">
        <div className="w-full h-[120px] lg:h-[138px] mt-2 mx-auto bg-[#fff2ed] rounded-[30px_30px_0px_0px] border border-white flex flex-col items-center justify-center">
          <div className="flex items-center gap-2.5">
            <span className="font-bold text-5xl lg:text-[70px] tracking-[-1.40px] leading-8 bg-[linear-gradient(180deg,rgba(114,0,98,1)_0%,rgba(255,45,125,1)_46%,rgba(246,120,0,1)_100%)] text-transparent bg-clip-text">
              {percentage}
            </span>
