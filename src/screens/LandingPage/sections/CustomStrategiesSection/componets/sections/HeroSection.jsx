...
export const HeroSection = ({ layer, logo, contactLogo, heroImage, navItems }) => {
  ...
  return (
    <section className="relative w-full min-h-[600px]  overflow-hidden bg-[linear-gradient(180deg,rgba(114,0,98,1)_0%,rgba(255,45,125,1)_46%,rgba(246,120,0,1)_100%)]">
      <div className="relative w-full h-full">
        ...
        <img className="absolute w-full h-full top-0 left-0 object-cover" alt="Layer" src={layer} />
        ...
        <header className="w-full h-16 md:h-20 absolute top-0 left-0 bg-transparent z-50">
          <div className="flex w-full max-w-[1320px] h-full mx-auto items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <img className="w-7 h-6 sm:w-8 sm:h-7 lg:w-[40.72px] lg:h-[35.65px]" alt="Logo" src={logo} />
              <span className="font-bold text-white text-base sm:text-lg lg:text-xl">Pyrahealth.ai</span>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Button className="hidden sm:flex rounded-full bg-white text-black font-bold items-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base px-3 sm:px-4 md:px-6 py-1 sm:py-2 hover:bg-gray-100 transition-colors">
                ...
                <img className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" alt="Chatting" src={contactLogo} />
              </Button>
        ...
        {/* Hero Content */}
        <div className="flex flex-col lg:flex-row w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 items-center justify-between gap-6 sm:gap-8 lg:gap-12 relative z-10 pt-20 sm:pt-24 lg:pt-32 pb-8 lg:pb-16">
          {/* Text Content */}
          <div className="flex flex-col w-full lg:w-1/2 items-start justify-center gap-3 sm:gap-4 lg:gap-6">
            ...
            <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl font-medium max-w-[705px]">
              <a href="http://pyrahealth.ai/" rel="noopener noreferrer" target="_blank" className="font-medium hover:underline">
                Pyrahealth.ai
              </a>{" "}
              is the AI-powered growth and operations partner for healthcare and wellness clinics.
            </p>
