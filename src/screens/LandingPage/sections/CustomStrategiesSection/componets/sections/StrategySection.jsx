          ...
          >
            <div className="flex flex-col w-full items-start gap-6 lg:gap-[30px]">
              {tabs.map((tab, index) => (
                <div
                  ...
                  className={`flex min-h-[100px] lg:h-[130px] items-center gap-4 w-full px-3.5 py-4 rounded-[5px] cursor-pointer hover:bg-white transition-all duration-300 ${
                    tab.isActive 
                ...
                >
                  <div className="flex flex-col w-full items-start gap-3 lg:gap-5">
                    <div className="flex flex-col items-start gap-2 lg:gap-3 w-full">
                      <h3
                        className={`text-primary-font text-lg lg:text-2xl leading-6 lg:leading-[32px] ${
            ...
            <div className="inline-flex h-[400px] lg:h-[605px] items-start absolute top-9  left-0">
              ...
              <div className="relative self-stretch w-[4.25px] ml-[-4.25px]">
                <div 
                  className="relative w-1.5 h-[100px] lg:h-[140px] rounded-[106.17px_106.17px_9px_0px] bg-[linear-gradient(180deg,rgba(114,0,98,1)_0%,rgba(255,45,125,1)_46%,rgba(246,120,0,1)_100%)]"
                  style={{
                    top: `${tabs.findIndex(t => t.isActive) * 140}px`, // Adjust based on your tab height
